...
public class DiscountStepDefinition {
	...
	@Given("^To start firefox and Launch the application for No Discount\\.$")
	...
	@When("^Tests to check for the input, weight \"([^\"]*)\" and distance \"([^\"]*)\" for No Discount\\.$")
	...
	@Then("^Test the scenario  whether the id result has the text \"([^\"]*)\" for No Discount\\.$")
